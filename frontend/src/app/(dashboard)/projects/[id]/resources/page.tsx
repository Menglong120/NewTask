...
import { Resource, ResourceFile } from '@/types/resource';
import { ResourceDialog } from './dialog/dialog';
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)] max-w-[1600px] mx-auto gap-6 animate-in fade-in duration-500">
      ...
      <ResourceDialog
        ...
        editFileNameShow={editFileNameShow}
        setFileInput={setFileInput}
        fileInput={fileInput}
        isSaving={isSaving}
        isUploading={isUploading}
        handleCreateResource={handleCreateResource}
        handleEditResourceSave={handleEditResourceSave}
